...
const G = {
  ...
  'bradesco-desconhecido-cartao-2024-06-30': NC('anuidade grátis para sempre; cartão sem bônus de ponto/milha (regra-mãe D-018)', ['anuidade_sem_pontos', 'flip_D018']),
  ...
  'nubank-desconhecido-cartao-2024-05-26': NC('Cartão Black anuidade grátis (roundup de ofertas); sem bônus de ponto/milha (regra-mãe D-018)', ['anuidade_sem_pontos', 'flip_D018']),
  ...
  'santander-aadvantage-cartao-2026-03': NC('anuidade grátis (slug); oferta é isenção de anuidade, sem bônus de ponto/milha (regra-mãe D-018)', ['anuidade_sem_pontos', 'flip_D018', 'titleless']),
